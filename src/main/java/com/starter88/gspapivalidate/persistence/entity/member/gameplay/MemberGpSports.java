...
@Entity
@Table(name = "tb_member_gp_sports")
public class MemberGpSports implements java.io.Serializable, Member {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3646950191678199785L;
	private Long idx;
	private int merchId;
