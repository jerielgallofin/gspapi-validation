package com.starter88.gspapivalidate.persistence.entity.member.gameplay;
...
@Entity
@Table(name = "tb_member_gp_betsoft")
public class MemberGpBetsoft implements java.io.Serializable, Member {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6228785052557651317L;
	private Long idx;
	private int merchId;
